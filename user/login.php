...
<link rel="stylesheet" href="login/yeti.css">
...
<form method="post" name="login">
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" id="loginEmail" maxlength="254" required="true" name="stuid" value="<?php if(isset($_COOKIE["user_login"])) { echo $_COOKIE["user_login"]; } ?>" />
		<!-- <p class="helper helper1">email@domain.com</p> -->
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Password</label>
		<input type="password" id="loginPassword" name="password" required="true" value="<?php if(isset($_COOKIE["userpassword"])) { echo $_COOKIE["userpassword"]; } ?>" />
	...
	<div class="inputGroup inputGroup3">
		<button type="submit" name="login" type="submit" id="login">Log in</button>
	</div>	
...
<script  src="login/yeti.js"></script>
