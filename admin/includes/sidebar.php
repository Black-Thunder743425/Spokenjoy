...
{               ?>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="manage-notice.php"> All Notices </a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="auth2">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="about-us.php">Quotes </a></li>
              ...
              <a class="nav-link" href="between-dates-reports.php">
                <span class="menu-title">Admission Reports</span>
            ...
            <li class="nav-item">
              <a class="nav-link" href="../user/forget-password.php">  <!-- add user/forget-password link after online upload -->
                <span class="menu-title">Modify Student Pswd</span>
                <i class="icon-screen-desktop menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../admin/forgot-password.php">  <!-- add Home link after online upload -->
                <span class="menu-title">Modify Mentor Pswd</span>
                <i class="icon-screen-desktop menu-icon"></i>
              </a>
            </li>
            </li>
